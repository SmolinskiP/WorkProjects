...
sudo iptables -A INPUT -p tcp -i enp6s0 --dport 33121 -j ACCEPT
sudo iptables -A INPUT -p udp -i enp6s0 --dport 33121 -j ACCEPT
sudo iptables -I FORWARD -p tcp -d 10.0.11.121 --dport 3389 -j ACCEPT
sudo iptables -t nat -I PREROUTING -p tcp -i enp6s0 -d 0/0 --dport 33121 -j DNAT --to-destination 10.0.11.121:3389
sudo iptables -I FORWARD -p udp -d 10.0.11.121 --dport 3389 -j ACCEPT
sudo iptables -t nat -I PREROUTING -p udp -i enp6s0 -d 0/0 --dport 33121 -j DNAT --to-destination 10.0.11.121:3389
