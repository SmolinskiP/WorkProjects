...
sudo iptables -D FORWARD -p udp -d 10.0.11.123 --dport 3389 -j ACCEPT
sudo iptables -t nat -D PREROUTING -p udp -i enp6s0 -d 0/0 --dport 33123 -j DNAT --to-destination 10.0.11.123:3389
